...
class CaixaMercado(QWidget):
    def __init__(self):
        ...
        self.label_titulo.setStyleSheet("QLabel{background-color:white;font-size-12pt}")
...
# ======================== Inicio do Total Liquido ===========================
        ...
        # Criar a label que terá o texto Desconto
        self.label_liq = QLabel("Total Liquído:")
        # Criar a LineEdit que recebe o total de desc
        self.edit_liq = QLineEdit("R$ 0,00")
        # adicionar a label_desc e a edit_desc ao layout horizontal desc
        self.layout_h_liquido.addWidget(self.label_liq)
        self.layout_h_liquido.addWidget(self.edit_liq)

        # Adiconar o layout_h_desconto a label _desconto
        self.label_liquido.setLayout(self.layout_h_liquido)

        # adicionar a label_desconto ao layout_v_esquerda
        self.layout_v_esquerda.addWidget(self.label_liquido) 
